...
void testPeriod() {
    ...
    assert(D_input.period_ == 200ms);
    assert(E_input.period_ == 1000ms);
    assert(F_input.period_ == 101ms);
    assert(G_input.period_ == 31ms);
    assert(H_input.period_ == 0ms);
    assert(I_input.period_ == 0ms);
    assert(AA_input.period_ == 0ms);
    assert(BB_input.period_ == 0ms);
    assert(AAA_input.period_ == 0ms);
    assert(BBB_input.period_ == 0ms);
    assert(CCC_input.period_ == 0ms);
    assert(DDD_input.period_ == 0ms);
    assert(DD_input.period_ == 0ms);
    assert(EE_input.period_ == 0ms);
    assert(FF_input.period_ == 0ms);
    assert(GG_input.period_ == 0ms);
    assert(HH_input.period_ == 0ms);
    assert(II_input.period_ == 0ms);
    assert(JJ_input.period_ == 0ms);
    assert(KK_input.period_ == 0ms);
    assert(LL_input.period_ == 0ms);
    assert(MM_input.period_ == 0ms);
    assert(NN_input.period_ == 0ms);
    assert(K_input.period_ == 0ms);
    assert(L_input.period_ == 103ms);
    assert(M_input.period_ == 103ms);
    assert(N_input.period_ == 0ms);
}
...
#define CREATE_TEST(ID, bus_idx, key, msg) \
  static void testMessageType##ID() { \
      ...
      assert(static_cast<map##bus_idx::Message_Type_T> (idx) == map##bus_idx::Message_Type_T::msg); \
  }
...
void testBusNames() {
    ...
    assert(D_input.name_ == Bus_Names_T::map1);
    assert(E_input.name_ == Bus_Names_T::map1);
    assert(F_input.name_ == Bus_Names_T::map2);
    assert(G_input.name_ == Bus_Names_T::map2);
    assert(H_input.name_ == Bus_Names_T::map2);
    assert(I_input.name_ == Bus_Names_T::map2);
    assert(AA_input.name_ == Bus_Names_T::map2);
    assert(BB_input.name_ == Bus_Names_T::map2);
    assert(AAA_input.name_ == Bus_Names_T::map2);
    assert(BBB_input.name_ == Bus_Names_T::map2);
    assert(CCC_input.name_ == Bus_Names_T::map2);
    assert(DDD_input.name_ == Bus_Names_T::map2);
    assert(DD_input.name_ == Bus_Names_T::map2);
    assert(EE_input.name_ == Bus_Names_T::map2);
    assert(FF_input.name_ == Bus_Names_T::map2);
    assert(GG_input.name_ == Bus_Names_T::map2);
    assert(HH_input.name_ == Bus_Names_T::map2);
    assert(II_input.name_ == Bus_Names_T::map2);
    assert(JJ_input.name_ == Bus_Names_T::map2);
    assert(KK_input.name_ == Bus_Names_T::map2);
    assert(LL_input.name_ == Bus_Names_T::map2);
    assert(MM_input.name_ == Bus_Names_T::map2);
    assert(NN_input.name_ == Bus_Names_T::map2);
    assert(K_input.name_ == Bus_Names_T::map2);
    assert(L_input.name_ == Bus_Names_T::map2);
    assert(M_input.name_ == Bus_Names_T::map2);
    assert(N_input.name_ == Bus_Names_T::map2);
}
